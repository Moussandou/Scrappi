...
export default function StickerTray({ isOpen, onClose, onSelectSticker }: StickerTrayProps) {
    ...
    return (
        <div className="fixed inset-x-4 top-20 bottom-24 md:absolute md:right-auto md:left-28 md:top-24 md:bottom-24 md:w-80 bg-white/80 backdrop-blur-md rounded-2xl shadow-soft border border-black/5 flex flex-col z-[80] overflow-hidden animate-in slide-in-from-left-8 duration-300 pointer-events-auto">
